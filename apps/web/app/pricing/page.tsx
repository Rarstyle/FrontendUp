...
import { useTimeTracking, useScrollTracking, trackButtonClick, trackPricingView, trackConversion } from '../../lib/analytics';
...
export default function PricingPage() {
  ...
  const handlePlanClick = (planName: string, planPrice: number) => {
    trackButtonClick(`pricing_${planName.toLowerCase()}`, 'pricing', 'cta', 'pricing_cards');
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-5">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Почему выбирают NeuroAd?</h2>
            ...
            {[
              {
                ...
                description: 'Средний результат наших клиентов за первые 30 дней'
              },
              {
                icon: '⚡',
              ...
              },
              {
                icon: '🎯',
                title: 'Объяснимый ИИ',
                description: 'Понимаете, почему ИИ предлагает именно эти варианты'
              }
            ].map((item, index) => (
          ...
          <div className="group relative">
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-2 h-full flex flex-col">
              <div className="text-center mb-6">
                ...
                <div className="text-4xl font-bold text-blue-600 mb-2">2 900 ₽</div>
                <div className="text-gray-500 mb-4">в месяц</div>
                <div className="bg-blue-50 rounded-xl p-3 mb-4">
                  <p className="text-blue-800 font-semibold">20 креативов / мес</p>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-2xl border-2 border-purple-200 hover:shadow-3xl transition-all duration-300 group-hover:-translate-y-2 relative h-full flex flex-col">
              <div className="text-center mb-6">
                ...
                <div className="bg-purple-50 rounded-xl p-3 mb-4">
                  <p className="text-purple-800 font-semibold">50 креативов / мес</p>
          ...
          <div className="group relative">
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-2 h-full flex flex-col">
              <div className="text-center mb-6">
                ...
                <div className="text-4xl font-bold text-green-600 mb-2">7 900 ₽</div>
                <div className="text-gray-500 mb-4">в месяц</div>
                <div className="bg-green-50 rounded-xl p-3 mb-4">
                  <p className="text-green-800 font-semibold">100 креативов / мес</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-5">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Что говорят клиенты</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            {[
              {
                ...
                answer: 'Да, вы можете отменить подписку в любое время. При отмене в течение 14 дней мы возвращаем полную стоимость.'
              },

              {
                question: 'Какие рекламные сети поддерживаются?',
                answer: 'Сейчас поддерживаются VK Ads и Яндекс Директ. В ближайшее время добавим другие сети.'
              },
              {
                question: 'Как быстро я увижу результаты?',
                answer: 'Первые результаты обычно видны в течение 1-2 недель после начала использования.'
              }
            ].map((item, index) => (
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-indigo-700 text-white">
        <div className="max-w-4xl mx-auto px-5 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button
              onClick={() => trackButtonClick('learn_more', 'pricing', 'secondary', 'footer')}
