      ...
      <div className="max-w-6xl mx-auto px-5 py-16">
        ...
        <section className="mb-20">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Наша миссия</h2>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-3xl p-8 md:p-12 border border-purple-100">
            <p className="text-xl md:text-2xl text-gray-700 text-center leading-relaxed font-medium mb-6">
              ...
              <span className="text-purple-600 font-bold">5 минут</span> повышает CTR рекламы на{' '}
            ...
            <div className="bg-white/70 rounded-2xl p-6 border border-purple-200">
              <h3 className="text-lg font-bold text-purple-800 mb-3">Что такое "объяснимый ИИ"?</h3>
              <p className="text-gray-700 leading-relaxed">
                В отличие от обычного ИИ, который работает как "чёрный ящик", наш алгоритм объясняет, 
                почему один креатив работает лучше другого. Мы анализируем психологические факторы 
                восприятия: цветовые акценты, эмоциональные триггеры, паттерны внимания и когнитивные 
                особенности аудитории. Это позволяет не просто получить результат, но и понять, 
                как воспроизвести успех в будущем.
              </p>
            </div>
          </div>
        </section>
              ...
              <div key={index} className="group relative">
                <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-2">
                  <div className="text-center mb-6">
                    <div className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br ${member.gradient} rounded-2xl mb-4 text-3xl`}>
                      {member.avatar}
                    </div>
            ...
            {[
              {
                ...
                description: 'Объясняем, почему один креатив работает лучше другого',
                gradient: 'from-blue-500 to-cyan-600'
              },
              {
                icon: '⚡',
              ...
              },
              {
                ...
                description: 'Успех наших клиентов — главный показатель нашей работы',
                gradient: 'from-green-500 to-emerald-600'
              },
            ].map((value, index) => (
              <div key={index} className="group relative">
                <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 hover:shadow-2xl transition-all duration-300 group-hover:-translate-y-2">
                  <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${value.gradient} rounded-2xl mb-6 text-2xl`}>
                    {value.icon}
                  </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-lg text-gray-700 font-semibold">Готовы к запуску</p>
                </div>
              </div>
            </div>
          </div>
