...
export default function HomePageClient() {
  ...
  return (
    <div>
      ...
      <section
        ref={heroRef}
        className="relative overflow-hidden bg-gradient-to-br from-purple-600 via-indigo-600 to-indigo-700 text-white py-20"
      >
        ...
        <div className="relative max-w-4xl mx-auto px-5 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              <Link
                href="/pricing"
                onClick={() => handleLinkClick('hero_cta_main', '/pricing')}
              >
                Посмотреть тарифы
              </Link>
            </button>
            <button
              onClick={() =>
                handleButtonClick('hero_cta_secondary', 'secondary', 'hero')
              }
            ...
            >
              <Link
                href="/about"
                onClick={() => handleLinkClick('hero_cta_secondary', '/about')}
              >
                Узнать больше
              </Link>
            </button>
      ...
      <section
        ref={finalCTARef}
        className="py-16 bg-gradient-to-r from-accent to-orange-500 relative overflow-hidden"
      >
        <div className="relative max-w-4xl mx-auto px-5 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
              onClick={() =>
                handleButtonClick('bottom_cta_main', 'cta', 'footer')
              }
            ...
            >
              <Link
                href="/pricing"
                onClick={() => handleLinkClick('bottom_cta_main', '/pricing')}
              >
                Посмотреть тарифы
              </Link>
            </button>
            <button
              onClick={() =>
                handleButtonClick('bottom_cta_secondary', 'secondary', 'footer')
              }
            ...
            >
              <Link
                href="/about"
                onClick={() =>
                  handleLinkClick('bottom_cta_secondary', '/about')
                }
              >
                Узнать больше
              </Link>
